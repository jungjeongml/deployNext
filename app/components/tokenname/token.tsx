...
export const TokenName = ({ token }: { token: Token }) => {
  const imags = {
    ...
    ETHLP: "https://stakingcrypto.info/static/assets/coins/coinbase-wrapped-staked-eth-logo.png",
  }
  return (
    <>
      <ContentsWrapST width={3.6} height={2} flex={"true"}>
        <img
